// src/pages/RentPage/RentItemPage.jsx
import React, { useEffect, useState } from "react";
import { useParams, Link } from "react-router-dom";
import { getFirestore, doc, getDoc } from "firebase/firestore";
import { app } from "../../firebase";
import MessageButton from "../ItemPage/MessageButton";
...
const RentItemPage = () => {
  ...
  useEffect(() => {
    const fetchItemData = async () => {
      ...
      const itemDoc = doc(db, "rentals", itemid);
            ...
            <div className="space-y-6">
              <div>
                ...
                <p className="text-2xl font-bold text-blue-500">
                  ₹{Number(item.rentPrice).toLocaleString("en-IN")} per hour
                </p>
                {item.year && (
                ...
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    <p className="font-medium">
                      {item.sellerName || "Anonymous Renter"}
                    </p>
